  ...
  return (
    <div>
      ...
      <main className="p-8 text-center">
        ...
        <div className="flex border p-4 w-3/4 mt-4 rounded shadow">
        <div>
        <h1 className="text-3xl font-bold mb-4">Get Started Today</h1>
          <p className=" flex justify-between m-4">Employers:  <Link href="/"><Button variant="outline"><StickyNote/>Post jobs</Button></Link></p>
          <p className="">Job Seekers: <Link href="/"><Button variant="outline"><Upload/>Apply for a job</Button></Link></p>
        </div>
