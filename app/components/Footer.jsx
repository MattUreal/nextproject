...
const Footer =()=>{
    return (
        <footer className=" bottom-0 left-0 z-20 w-full p-4">
            ...
            <div className="px-4 py-6  md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">©2024 HRM System. All rights reserved.
                </span>
